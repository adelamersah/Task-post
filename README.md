    ...
    <section class="hero" id="home">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-btns">
                    <a href="#how-it-works" class="btn btn-primary">اطلب Task Post الآن!</a>
        ...
        <div class="container">
            ...
            <div class="steps-container">
                <div class="step">
                    ...
                    <h3>اطلب بضغطة زر</h3>
                    <p>اطلب خدمتك بسهولة من موقعنا أو عبر الهاتف في دقائق معدودة</p>
                </div>
                <div class="step">
                ...
                <div class="step">
                    ...
                    <p>تتبع شحنتك لحظة بلحظة حتى تأكيد الاستلام</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="features-container">
                <div class="features-content">
                    ...
                    <div class="hero-btns" style="margin-top: 30px;">
                        <a href="#" class="btn btn-primary">بريد صورباهر صار أقرب وأسرع </a>
                    </div>
                </div>
                <div class="features-grid">
                    ...
                    <div class="feature-card">
                        ...
                        <p>تابع شحنتك خطوة بخطوة عبر نظام التتبع المباشر</p>
                    </div>
                </div>
            </div>
        </div>
...
## كيفية نشر الصفحة على GitHub

لقد أضفت قسمًا خاصًا في الصفحة يوضح كيفية نشرها على GitHub. إليك الخطوات المفصلة:

### 1. إنشاء مستودع على GitHub
- سجل الدخول إلى حساب GitHub الخاص بك
- انقر على "+" في الزاوية العلوية اليمنى واختر "New repository"
- أدخل اسم المستودع: `Task-Post`
- اختر "Public"
- اختر "Initialize this repository with a README" (اختياري)
- انقر على "Create repository"

### 2. رفع ملفات المشروع
- انسخ كود HTML أعلاه واحفظه في ملف باسم `index.html`
- في مستودع GitHub، انقر على "Add file" > "Upload files"
- اسحب وأسقط ملف `index.html` في المساحة المخصصة
- أضف ملفًا آخر باسم `CNAME` (بدون امتداد) إذا كنت تريد استخدام نطاق مخصص
- داخل ملف CNAME اكتب: `taskpost.com` (أو أي نطاق تملكه)
- انقر على "Commit changes"

### 3. تفعيل GitHub Pages
- في المستودع، انقر على "Settings"
- في الشريط الجانبي، انقر على "Pages"
- تحت "Branch"، اختر الفرع الذي يحتوي على ملفاتك (مثل `main` أو `master`)
- اختر المجلد `/root`
- انقر على "Save"
- بعد لحظات، ستظهر رابط موقعك الجديد (مثل: `https://<username>.github.io/Task-Post/`)

### 4. استخدام نطاق مخصص (اختياري)
- اشترِ نطاقًا (مثل taskpost.com) من خلال خدمات مثل Namecheap أو GoDaddy
- أنشئ سجلات DNS:
  - نوع A مع القيمة `185.199.108.153`
  - نوع A مع القيمة `185.199.109.153`
  - نوع A مع القيمة `185.199.110.153`
  - نوع A مع القيمة `185.199.111.153`
- أو استخدم سجلات CNAME:
  - اسم: `www` -> يشير إلى `<username>.github.io`
- في إعدادات GitHub Pages، أدخل نطاقك في قسم "Custom domain"

## مميزات الصفحة
- تصميم عصري متجاوب يعمل على جميع الأجهزة
- تضمين رقم الاتصال (+972 50-467-0703) في عدة أماكن بارزة
- قسم خاص بـ GitHub يوضح كيفية الوصول إلى المستودع والصفحة الحية
- ألوان جذابة باستخدام اللونين الرمادي والخمري
- رسوم متحركة وتأثيرات تفاعلية لتحسين تجربة المستخدم

يمكنك الوصول إلى الصفحة مباشرة من خلال الرابط: [https://your-username.github.io/Task-Post/](https://your-username.github.io/Task-Post
